    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='projectpack_manager', to='accounts.Profile', verbose_name='مدیر پک پروژه')),
                ('monitoring_manager', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='projectpack_monitoring_manager', to='accounts.Profile', verbose_name='ناظر پک پروژه')),
            ],
        ),
    ]
