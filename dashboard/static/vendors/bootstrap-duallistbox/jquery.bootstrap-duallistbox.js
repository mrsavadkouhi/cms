...
;(function ($, window, document, undefined) {
	...
	BootstrapDualListbox.prototype = {
		init: function () {
			...
			this.setBootstrap4Compatible(this.settings.bootstrap4Compatible);
		...
		setBootstrap4Compatible: function (value, refresh) {
			this.settings.bootstrap2Compatible = value;
			if (value) {
				this.container.find('.clear1, .clear2').removeClass('btn-xs').addClass('btn-sm');
				// this.container.find('input, select').removeClass('form-control');
				this.container.find('.btn').removeClass('btn-default').addClass('btn-info');
				...
				this.setInfoTextFiltered('<span class="badge badge-pill badge-warning">Filtered</span> {0} from {1}');
			} else {
				// this.container.removeClass('row-fluid bs2compatible').addClass('row');
				this.container.find('.clear1, .clear2').removeClass('btn-sm').addClass('btn-xs');
				// this.container.find('input, select').addClass('form-control');
				this.container.find('.btn').removeClass('btn-info').addClass('btn-default');
